...
namespace nusal {
  ...
  [[maybe_unused]] static const std::vector<tipe_token_data<tipe_token>>&
  nusa_data_tipe_token() {
    static std::vector<tipe_token_data<tipe_token>> output = {
        ...
        {tipe_token::GARIS_VERTIKAL,           ubah_ke_string(tipe_token::GARIS_VERTIKAL),
         R"(\|)"                                                                                     },
        {tipe_token::KURUNG_BUKA,              ubah_ke_string(tipe_token::KURUNG_BUKA),
         R"(\()"                                                                                     },
